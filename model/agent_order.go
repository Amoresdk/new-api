...
// AgentPurchaseOrder records an agent's batch purchase and its immutable
...
type AgentPurchaseOrder struct {
	...
	TotalPrice          int64  `json:"total_price" gorm:"type:bigint;not null"`
	...
	RefundedAmount      int64  `json:"refunded_amount" gorm:"type:bigint;not null"`
